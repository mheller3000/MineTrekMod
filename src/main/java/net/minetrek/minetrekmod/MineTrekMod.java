...
public class MineTrekMod {
	...
	// Create instances of our Creative Tabs.  Calls the rendering process to include listed separate tabs pages in the inventory client view... 
	// ...for categorization and grouping of blocks.
	...
	public static final CreativeTabs TAB_32ND_CENTURY = new CTab("tab_32nd", ItemInit.ITEM_32ND_ICON, "32ndbg.png", false);
	public static final CreativeTabs TAB_JJ = new CTab("tab_jj", ItemInit.ITEM_JJ_ICON, "jjbg.png", false);
	public static final CreativeTabs TAB_HULL_FLATBLOCKSBG = new CTab("tab_hull_flatblocksbg", ItemInit.ITEM_HULL_FLATBLOCKSBG_ICON, "hull_flatblocksbg.png", false);
	public static final CreativeTabs TAB_LCARS = new CTab("tab_lcars", ItemInit.ITEM_LCARS_ICON, "lcarsbg.png", false);
	 ...
	 * that your Mod provides. It runs before initialization.
	 * 
	 * Used for Renders
	 ...
	 * and blocks set up in preInit. It runs on initialization.
	 * 
	 ...
	 * upon by other Mods. It runs after initialization.
	 * 
