...
/*
 * Class to extend and customise a BlockFacing for small diagonal corner bits, with
 * adjusted boundary boxes (Sovereign Corridor B blocks)
 * 
 * 
 * TODO:
 * Create new Bounding Boxes for the little corner blocks to use with the
 * Sovereign Corridor B Blocks and maybe others in the future
 * 
 */
public class BlockDiagonalCorner extends BlockFacing implements IHasModel
{
	 ...
	 */
	public BlockDiagonalCorner(String name, Material material, CreativeTabs tab)
	{
	 ...
	 */
	public BlockDiagonalCorner(String name, Material material, CreativeTabs tab, float lightLevel, int lightOpacity, SoundType sound)
	{
		super(name, material, tab);	
